            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('admin.service.update', $service->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="exampleInputEmail3"
                                    placeholder="Enter calss icon" name="icon" value="{{ old('icon', $service->icon) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="discription" class="form-control" id="exampleInputEmail3" cols="30" rows="5">{{ old('discription', $service->discription) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" aria-label="Default select example" name="status">
                                    <option value="0" @if (old('status', $service->status) == 0) selected @endif>Inactive
                                    </option>

                                    <option value="1" @if (old('status', $service->status) == 1) selected @endif>Active
                                    </option>
