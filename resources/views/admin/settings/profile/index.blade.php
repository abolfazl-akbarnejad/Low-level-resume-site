        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-12 grid-margin ">
                    <div class="card class-of-the-div-with-extra-width ">
                        <div class="card-body ">
                            ...
                            <div class="table-responsive ">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th> Name </th>
                                        <td>{{ $profileSetting->name }}</td>
                                    </tr>
                                    <tr>
                                        <th> Work Pakage </th>
                                        <td>{{ $profileSetting->workPakage }}</td>
                                    </tr>
                                    <tr>
                                        <th> Date Birth </th>
                                        <td>{{ $profileSetting->dateBirth }}</td>
                                    </tr>
                                    <tr>
                                        <th> Biography </th>
                                        <td style="width: auto; height: auto; white-space: normal;font-size: 17px">
                                            {{ $profileSetting->biography }}</td>
                                    </tr>
                                    <tr>
                                        <th> Profile Image </th>
                                        <td style=" white-space: pre;">

                                            <img src="  {{ asset($profileSetting->profileImage) }}" alt=""
                                                style="width: 430px ;height: 603px;border-radius: 0%" class="rounded">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Main Image</th>
                                        <td style=" white-space: pre;">
                                            <img src=" {{ asset($profileSetting->mainImage) }}" alt=""
                                                style="width: 500px ;height: 150px;border-radius: 0%">
                                        </td>
                                    </tr>
