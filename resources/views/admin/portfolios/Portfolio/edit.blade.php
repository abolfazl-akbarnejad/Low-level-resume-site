            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('admin.portfolio.update', $Portfolio->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1"
                                    placeholder="https://www.google.com" name="url"
                                ...
                                <select class="form-select" aria-label="Default select example" name="cat_id">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" 
                                            @if (old('cat_id', $Portfolio->cat_id) == $category->id) selected @endif
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" aria-label="Default select example" name="status">
                                    <option value="0" @if (old('status', $Portfolio->status) == 0) selected @endif>Inactive
                                    </option>

                                    <option value="1" @if (old('status', $Portfolio->status) == 1) selected @endif>Active
                                    </option>
