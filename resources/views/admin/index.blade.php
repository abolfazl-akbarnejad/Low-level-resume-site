                        ...
                        <div class="col-md-5 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    {{-- <form action="{{ route('admin.note.create') }}" method="POST"
                                        style="display: inline-block">


                                            <input type="text" class="form-control todo-list-input"
                                                placeholder="What do you need to do today?" name="text">
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                id="add-task">Add</button>

                                    </form> --}}

                                    <h3 id="note-responce"></h3>
                                                ...
                                                <li>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="checkbox" type="checkbox">{{ $note->name }}
                                                        </label>
                                                    </div>
            ...
            $('#formNote').submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#note-responce').html(response.message);
                    }
                });
